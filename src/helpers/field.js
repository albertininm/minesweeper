function canMoveLeft(matrix, x, y) {
  ...
  return matrix[x][y-1] && !matrix[x][y-1].isBomb && !matrix[x][y-1].selected;
}
...
function canMoveTop(matrix, x, y) {
  ...
  return matrix[x-1][y] && !matrix[x-1][y].isBomb && !matrix[x-1][y].selected;
}
...
function canMoveTopRight(matrix, x, y) {
  ...
  return matrix[x-1][y+1] && !matrix[x-1][y+1].isBomb && !matrix[x-1][y+1].selected;
}
